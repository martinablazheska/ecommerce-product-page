...
let currentIndex = 0;
let currentImage = document.querySelector('.product-preview').style.backgroundImage;
...
nextButton.addEventListener('click', function(){
    ...
    document.querySelector('.product-preview').style.backgroundImage=products[currentIndex];
    }
)
...
document.querySelector('.photo:nth-of-type(1)').addEventListener('click', function(){
...
document.querySelector('.photo:nth-of-type(2)').addEventListener('click', function(){
    selectedPhoto.classList.remove('selected');
...
document.querySelector('.photo:nth-of-type(3)').addEventListener('click', function(){
    selectedPhoto.classList.remove('selected');
...
document.querySelector('.photo:nth-of-type(4)').addEventListener('click', function(){
    selectedPhoto.classList.remove('selected');
